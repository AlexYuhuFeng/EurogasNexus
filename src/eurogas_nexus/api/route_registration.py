...
from eurogas_nexus.api.routes.dev.health import router as dev_health_router
from eurogas_nexus.api.routes.internal.health import router as internal_health_router
