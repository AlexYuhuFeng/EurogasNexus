"""Validate the V1 runtime DB non-destructively (operator-invoked).

Never writes, never prints a full DSN, never runs migrations.

Usage:
    python scripts/ops/validate_v1_runtime_db.py
...
def _resolve_db_dsn() -> str | None:
    """Resolve DB DSN using the V1 precedence chain."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Eurogas Nexus V1 runtime DB validation")
