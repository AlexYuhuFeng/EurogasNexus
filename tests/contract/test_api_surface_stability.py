...
PINNED_PUBLIC_PATHS = {
    ...
    "/api/analysis-snapshots/{snapshot_id}",
    ...
    "/api/decision-cases/{case_id}/decisions",
    "/api/decision-cases/{case_id}/evidence",
    "/api/decision-cases/{case_id}/reopen",
    "/api/dev/auth/login",
    "/api/dev/health",
    "/api/glossary",
    "/api/glossary/{term}",
    ...
    "/api/research/datasets/{dataset_snapshot_id}",
    "/api/research/datasets/{dataset_snapshot_id}/export",
    "/api/research/datasets/{dataset_snapshot_id}/quality",
    "/api/research/features",
    "/api/research/features/{feature_id}",
