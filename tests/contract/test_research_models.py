...
def test_route_cost_result() -> None:
    from eurogas_nexus.domain.research.models import RouteCostResult
...
def test_indicative_netback() -> None:
    from eurogas_nexus.domain.research.models import IndicativeNetbackResult
...
def test_feasibility_result() -> None:
    from eurogas_nexus.domain.research.models import FeasibilityResult, FeasibilityStatus
...
def test_allocation_scenario() -> None:
    from eurogas_nexus.domain.research.models import AllocationScenarioResult
...
def test_monitoring_alert() -> None:
    from eurogas_nexus.domain.research.models import AlertSeverity, MonitoringAlert
...
def test_nowcast_result() -> None:
    from eurogas_nexus.domain.research.models import NowcastResult
...
def test_backtest_result() -> None:
    from eurogas_nexus.domain.research.models import BacktestResult
...
def test_shadow_run_result() -> None:
    from eurogas_nexus.domain.research.models import ShadowRunResult, ShadowRunStatus
...
def test_candidate_actions_are_research_only() -> None:
    from eurogas_nexus.domain.research.models import CandidateAction
...
def test_llm_market_analysis() -> None:
    from eurogas_nexus.domain.research.models import LlmMarketAnalysis
...
def test_research_brief() -> None:
    from eurogas_nexus.domain.research.models import ResearchBrief
