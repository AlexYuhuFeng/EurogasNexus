...
CHECKED_MODULES = [
    ...
    "workflows/allocation.py",
    "workflows/backtest.py",
    "workflows/feasibility.py",
    "workflows/models.py",
    "workflows/monitoring.py",
    "workflows/netback.py",
    "workflows/nowcast.py",
    "workflows/route_cost.py",
    "workflows/shadow_run.py",
    "mcp/server.py",
    "cli/commands.py",
    "cli/main.py",
    # SDK 公开 API 面
