...
- `docs/archive/agent-plans/V1_R2_RUNTIME_STORE_GOVERNANCE_EXECPLAN.md` — ExecPlan
- `docs/archive/reports/release_v1/r2_runtime_governance_report.md` — This report
