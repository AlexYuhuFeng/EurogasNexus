...
- Server owns a loopback-only PostgreSQL/API runtime and desktop Client on one
...
- The Server NSIS package embeds the desktop Client and API image. It requires
...
Server NSIS packaging are implemented.
